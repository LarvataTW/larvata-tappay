...
return [
    ...
    'payment_success_callback_class_name' => env('PAYMENT_SUCCESS_CALLBACK_CLASS_NAME', 'App\Services\Orders\PaymentSuccessCallback'),
    'payment_failure_callback_class_name' => env('PAYMENT_FAILURE_CALLBACK_CLASS_NAME', 'App\Services\Orders\PaymentFailureCallback'),
];
